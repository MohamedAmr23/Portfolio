...
const Work = () => {
  return (
    <div id='work' className='w-full py-10 pt-24 scroll-mt-20  px-[12%]'>
         ...
         <p className='text-center text-gray-700 max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my web development portfolio! Explore a collection of projects showcasing
         my expertise in front-end development.</p>
         <ul className='grid grid-cols-auto gap-5 my-10'>
            ...
            <a  className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500'>Show more <Image src={assets.right_arrow_bold} alt='' className='w-4' /></a>
    </div>
  )
}
