...
const Services = () => {
  return (
    <div id='services' className='w-full py-10 scroll-mt-20  px-[12%]'>
         ...
         <p className='text-center text-gray-700 max-w-2xl mx-auto mt-5 mb-12 font-Ovo dark:text-white'>I am a frontend developer from Egypt,  with 4 years of experience .</p>
         <ul className='grid grid-cols-auto gap-6 my-10 '>
            {serviceData.map(({icon,title,description,link},index)=>(
                <li key={index} className='border border-gray-400 rounded-lg px-8 py-12  cursor-pointer hover:bg-lightHover hover:-translate-y-1 duration-500 hover:shadow-black dark:hover:bg-darkHover dark:hover:shadow-white'>
