...
const Contact = () => {
  ...
  return (
    <div id="contact" className={`w-full py-10 pt-24 scroll-mt-20  px-[12%]`}>
      ...
      <p className="text-center text-gray-700 max-w-2xl mx-auto mt-5 mb-12 font-Ovo">
      ...
      <form onSubmit={onSubmit} className="max-w-2xl mx-auto">
        ...
        <button
          type="submit"
          className="w-max flex items-center justify-between gap-2 bg-black/80 text-white  rounded-full py-3 px-8 mx-auto  hover:bg-black duration-500"
        >
          Submit now
